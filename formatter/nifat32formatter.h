...
#define DEFAULT_VOLUME_SIZE 	(10 * 1024 * 1024)
#define BYTES_PER_SECTOR 		512
#define SECTORS_PER_CLUSTER 	8
#define RESERVED_SECTORS 		32
#define FAT_COUNT 				2
#define ROOT_DIR_CLUSTER 		2
#define ROOT_DIR_OFFSET 		(BYTES_PER_SECTOR * (RESERVED_SECTORS + FAT_COUNT * 32))

#define CLUSTER_SIZE (BYTES_PER_SECTOR * SECTORS_PER_CLUSTER)
#define FAT_ENTRIES (DEFAULT_VOLUME_SIZE / CLUSTER_SIZE)
#define FAT_OFFSET (BYTES_PER_SECTOR * RESERVED_SECTORS)
#define DATA_REGION_OFFSET (FAT_OFFSET + FAT_COUNT * FAT_ENTRIES * sizeof(uint32_t))
